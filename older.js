...
ready(function () {
  var popup = new Agegate({
    cancelUrl: "https://apero-detente.fr/",
  });
});
...
!(function (e) {
  ...
  (e.Agegate = function (e) {
    var t = {
      cookie: "popup_agreed",
      body: "Vous certifier avoir 18 ans ou plus ?",
      cancelUrl: "/",
      expires: 7,
      success: function () {},
      fail: function () {},
    ...
    if (
      ((e = void 0 !== e ? e : {}),
      this.setOptions(e, t),
      !this.checkCookie(this.options.cookie))
    )
      return (
        this.createPopup(),
    ...
    (Agegate.prototype = {
      createPopup: function () {
        (this.container = document.createElement("div")),
          (this.container.innerHTML = [
            ...
            '<h1 class="title-popup">Bienvenue Chez Apero Détente !</h1>',
            '<br>',
            '<div class="popup-body">',
            this.options.body,
            "</div>",
            '<div class="popup-actions">',
            '<button class="popup-btn popup-agree">Oui</button>',
            '<button class="popup-btn popup-cancel">Non</button>',
            "</div>",
            "</div>",
            "</div>",
          ].join("")),
      ...
      failHandler: function () {
        this.options.fail(), (e.location.href = this.options.cancelUrl);
      },
      setOptions: function (e, t) {
        this.options = Object.assign(t, e, { defaults: t });
      },
      checkCookie: function (e) {
        return Cookies.get(e);
      },
      setCookie: function () {
        Cookies.set(this.options.cookie, !0, { expires: this.options.expires });
      },
      setEventHandlers: function () {
        this.agreeBtn.addEventListener(
          "click",
            ...
            for (
              ...
              try {
                ...
                if (
                  ((h = o.read
                    ? o.read(h, v)
                    : o(h, v) || h.replace(u, decodeURIComponent)),
                  this.json)
                )
                  try {
                    h = JSON.parse(h);
